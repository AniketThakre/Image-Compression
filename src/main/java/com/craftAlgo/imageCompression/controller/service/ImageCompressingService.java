package com.craftAlgo.imageCompression.controller.service;
...
public class ImageCompressingService {
    ...
    public String processJPEG(String file) throws IOException
    {
        ...
        File input = new File( "/upload/" + file);
    ...
    {
        // Create the input file
        PngImage inoutImage = new PngImage(Files.newInputStream(Paths.get(uploadDir + File.separator + file)));
        ...
        PngImage optimized = optimizer.optimize(inoutImage);
